...
print(cupClass1.percentageFull, cupStruct1.percentageFull) // класа направен по този начин е като направиш нещо за кой да е важи за всички, структурата е индивидуално
